              ...
              <div className="slider-content-wrapper">
                <div className="swiper-wrapper">
                  <div className="slider-content">
                    ...
                    <p>
                      Rest Easy, We've Got You Covered: Our Finest Safety Systems Include Proactive Security Measures
                      and On-Site, Trained Security Personnel.
                    </p>
                    <ul>
                      <li>
                        <svg
                      ...
                      <li>
                        ...
                        On-site amenities (restaurants, pools, gyms)
                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
