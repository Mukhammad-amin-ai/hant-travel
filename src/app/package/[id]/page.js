    ...
    <>
      ...
      <div className="package-details-area pt-120 mb-120 position-relative">
        <div className="container">
          ...
          <div className="row g-xl-4 gy-5">
            <div className="col-xl-8">
              <h2>{packageShow[0].title}</h2>
              <div className="tour-price">
                <h3> ${packageShow[0].price}</h3>
              ...
              <ul className="tour-info-metalist">
                ...
                <li>
                  ...
                  Max People : {packageShow[0].maxPeople}
                </li>
                <li>
                  <svg
                    width={14}
                  ...
                  {packageShow[0].location}
                </li>
              </ul>
              <p>{packageShow[0].description}</p>
              <h4>Included</h4>
              <div className="includ-and-exclud-area mb-20">
                <ul>
                  {packageShow[0].iclueded.map((item, index) => (
                    <li key={index}>
              ...
              <div className="highlight-tour mb-20">
                <h4>Additionally</h4>
                <ul>
                  {packageShow[0].excluded.map((item, index) => (
                    <li key={index}>
                      <span>
              ...
              <div className="accordion tour-plan" id="tourPlan">
                {packageShow[0].plan.map((item, index) => (
        ...
        <Lightbox
          ...
          slides={packageShow[0].galley.map(function (elem) {
            return { src: elem.img };
          })}
        />
        <React.Fragment>
