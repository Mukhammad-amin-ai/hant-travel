          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              ...
              <ul className="visa-meta">
                <li>
                  <span>Country :</span> {visaDetails[router - 1].country}
                </li>
                <li>
                  <span>Visa Type :</span> {visaDetails[router - 1].visaType}
                </li>
                <li>
                  <span>Maximum Stays :</span> {visaDetails[router - 1].max}{" "}
                  Days
                </li>
                <li>
                  <span>Processing Time :</span> {visaDetails[router - 1].time}{" "}
                  Working Day
                </li>
                <li>
                  <span>Validity :</span> {visaDetails[router - 1].length} Days
                </li>
                <li>
                  <span>Visa Mode :</span> {visaDetails[router - 1].model}
                </li>
              </ul>
            ...
            <div className="col-lg-4">
              <div className="visa-sidebar mb-30">
                <div className="sidebar-top text-center">
                  <h4>Cost Summary</h4>
                  <h6>
                    $ {visaDetails[router - 1].price} <span>per person</span>
                  </h6>
